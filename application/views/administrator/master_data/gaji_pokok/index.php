                ...
                <div class="ibox float-e-margins">
                    ...
                    <tr class="gradeX">
                        ...
                        <ul class="dropdown-menu">
                         <li><a href="<?php echo base_url('administrator/data_gaji_pokok/edit/'.$a['id_gaji_pokok']);?>"><i class="fa fa-edit"></i> Edit</a></li>
                         <li><a href="<?php echo base_url('administrator/data_gaji_pokok/hapus/'.$a['id_gaji_pokok']);?>" onclick="return confirm('Apakah anda yakin akan menghapus data ini?')"><i class="fa fa-times-circle-o" ></i> Hapus</a></li>
                        </ul>
                        </button>
                        </div>
                        </td>
