...
<!-- Mirrored from webapplayers.com/inspinia_admin-v1.8/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 21 Jan 2015 22:38:28 GMT -->
<head>
        ...
        <nav class="navbar-default navbar-static-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="side-menu">
                    <li class="nav-header">
                        <div class="dropdown profile-element"> <span>
                            ...
                            <ul class="dropdown-menu animated fadeInRight m-t-xs">
                                <li><a href="<?php echo base_url('login/changed_password'); ?>">Pengaturan Akun</a></li>
                                <li><a href="<?php echo base_url('login/changed_password'); ?>">Manajemen User</a></li>
                                <li class="divider"></li>
                    ...
                    <li class="active">
                        <a href="<?php echo base_url('operator'); ?>"><i class="fa fa-th-large"></i> <span class="nav-label">Dashboards</span></a>
                    </li>
                    <li>
                        <a href="#"><i class="fa fa-bar-chart-o"></i> <span class="nav-label">Pegawai</span><span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            <li><a href="graph_flot.html">Input Pegawai</a></li>
                        </ul>
                    </li>
                    <li>
