        ...
        <div class="wrapper wrapper-content animated fadeInRight">
            <div class="row">
                ...
                <div class="ibox float-e-margins">
                    ...
                    <?php if ($data_riwayat_jabatan->num_rows()<=0){?>
                    <a href="<?php echo base_url('pegawai/data_riwayat_jabatan/tambah');?>" class="btn btn-outline btn-default btn-sm" type="button"><i class="fa fa-plus-square-o"></i> Tambah</a>
                    <?php } ?>
                    ...
                    <tr class="gradeX">
                        ...
                        <ul class="dropdown-menu">
                         <li><a href="<?php echo base_url('pegawai/data_riwayat_jabatan/edit/'.$a['id_riwayat_jabatan']);?>"><i class="fa fa-edit"></i> Edit</a></li>
                         <li><a href="<?php echo base_url('pegawai/data_riwayat_jabatan/hapus/'.$a['id_riwayat_jabatan']);?>" onclick="return confirm('Apakah anda yakin akan menghapus data ini?')"><i class="fa fa-times-circle-o" ></i> Hapus</a></li>
                        </ul>
                        </button>
                        </div>
                        </td>
...
<div class="col-sm-8"><input type="text" value="<?php echo $a['nama_jabatan']?>" class="form-control" disabled></div></div>
<div class="form-group"><label class="col-sm-4 control-label">Unit Kerja</label>
<div class="col-sm-8"><textarea type="textarea" class="form-control" disabled><?php echo $a['nama_unit_kerja']?></textarea></div></div>
<div class="form-group"><label class="col-sm-4 control-label">Uraian</label>
<div class="col-sm-8"><textarea type="textarea" class="form-control" disabled><?php echo $a['uraian']?></textarea></div></div>
<div class="form-group"><label class="col-sm-4 control-label">Eselon</label>
<div class="col-sm-8"><input type="tex" class="form-control" value="<?php echo $a['nama_eselon']?>" disabled></div></div>
...
<div class="form-group"><label class="col-sm-4 control-label">Lokasi</label>
<div class="col-sm-8"><input type="text" value="<?php echo $a['lokasi']?>" class="form-control" disabled></div></div>
</p>
