...
<head>
    ...
    <title>SIMPEG | Home-Pegawai</title>
        ...
        <nav class="navbar-default navbar-static-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="side-menu">
                    ...
                    <li class="active">
                        <a href="<?php echo base_url('pegawai/home'); ?>"><i class="fa fa-th-large"></i> <span class="nav-label">Home</span></a>
                    </li>
                    <li>
                        <a href="#"><i class="fa fa-archive"></i> <span class="nav-label">Data-data Saya</span><span class="fa arrow"></span></a>
